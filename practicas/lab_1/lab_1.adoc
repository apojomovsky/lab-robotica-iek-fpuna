...
image::assets/conda-new-environment.png[Creación de un nuevo entorno en Anaconda]
...
image::assets/conda-default-environment.png[Elegir environment por defecto]
...
image::assets/conda-open-terminal.png[Abrir terminal para el entorno]
...
image::assets/install-jupyter-lab.png[Instalar JupyerLab]
...
image::assets/jupyter-lab-gui.png[Pantalla principal JupyterLab]
...
image::assets/jupyter-lab-lab1.png[Notebook para laboratorio 1]
